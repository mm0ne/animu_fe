...
export default function AnimeThumbnail({image_link, mal_link ,detail, genres, aliases}: AnimeThumbnailProps){
    ...
    return(
        <section className="flex flex-col justify-start gap-y-3 w-full lg:max-w-[15em] px-2 py-4 lg:py-0">
            ...
            <Link target="_blank" href={mal_link} className="w-full self-center lg:w-full flex justify-center items-center font-semibold gap-x-1 bg-blue-600 py-1 rounded-md hover:text-yellow-500 transition-all duration-100">
